...
export class CreateInitialTables1683687364443 implements MigrationInterface {
    name = 'CreateInitialTables1683687364443'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "job_offer" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "email" text NOT NULL, "description" text NOT NULL, "phone" text NOT NULL, "status" text NOT NULL, "mainLocalId" uuid, CONSTRAINT "PK_5286026037ab5fb5acfcb7e1829" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "role" ("id" SERIAL NOT NULL, "roleName" text NOT NULL, CONSTRAINT "PK_b36bcfe02fc8de3c57a8b2391c2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "firstName" text NOT NULL, "lastName" text NOT NULL, "nickName" text NOT NULL, "email" text NOT NULL, "password" character varying NOT NULL, "roleId" integer, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "main_local" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "email" text NOT NULL, "phone" text NOT NULL, "location" text NOT NULL, "description" text NOT NULL, "workingHours" integer NOT NULL, "facebook" text NOT NULL, "instagram" text NOT NULL, "twitter" text NOT NULL, "userId" uuid, CONSTRAINT "PK_ba5663b5b7ffbca8ef77d747662" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "daily_offer" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" text NOT NULL, "newPrice" numeric NOT NULL, "categoryId" uuid, "mainLocalId" uuid, CONSTRAINT "PK_a7cdd73410c2e13b25a0027bc1b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "category" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "description" text NOT NULL, "categoryName" text NOT NULL, CONSTRAINT "PK_9c4e4a89e3674fc9f382d733f03" PRIMARY KEY ("id"))`);
